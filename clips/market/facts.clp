...
(deffacts customers
  ...
  (customer (customer-id 101) (name "Joe") (address "123 Main St") (phone 3313073905)    (refered-by 0) )
  (customer (customer-id 102) (name "Mary") (address "456 Elm St") (phone 333222345)     (refered-by 101) )
  (customer (customer-id 103) (name "Bob") (address "789 Oak St") (phone 331567890)      (refered-by 101) )
  (customer (customer-id 104) (name "Alice") (address "987 Birch St") (phone 335555555)  (refered-by 101) )
  (customer (customer-id 105) (name "David") (address "567 Cedar St") (phone 331234567)  (refered-by 101) )
  (customer (customer-id 106) (name "Carol") (address "876 Pine St") (phone 331999999)   (refered-by 101) )
  (customer (customer-id 107) (name "Eve") (address "234 Maple St") (phone 331222333)    (refered-by ) )
  (customer (customer-id 108) (name "Frank") (address "543 Walnut St") (phone 332222444) (refered-by ) )
  (customer (customer-id 109) (name "Grace") (address "654 Ash St") (phone 334444666)    (refered-by ) )
  (customer (customer-id 110) (name "Harry") (address "789 Cherry St") (phone 331111222) (refered-by ) )
  (customer (customer-id 111) (name "Ivy") (address "432 Sycamore St") (phone 331122333) (refered-by ) )
  (customer (customer-id 112) (name "Jack") (address "876 Fir St") (phone 331333444)     (refered-by ) )
  (customer (customer-id 113) (name "Kate") (address "234 Oak St") (phone 334444777)     (refered-by ) )
  (customer (customer-id 114) (name "Liam") (address "567 Birch St") (phone 331245678)   (refered-by ) )
  (customer (customer-id 115) (name "Mia") (address "345 Elm St") (phone 331765432)      (refered-by ) )
  (customer (customer-id 116) (name "Noah") (address "654 Pine St") (phone 332222333)    (refered-by ) )
  (customer (customer-id 117) (name "Olivia") (address "789 Walnut St") (phone 334444555)(refered-by ) )
  (customer (customer-id 118) (name "Parker") (address "876 Cedar St") (phone 331222777) (refered-by ) )
  (customer (customer-id 119) (name "Quinn") (address "123 Cedar St") (phone 331222888)  (refered-by ) )
  (customer (customer-id 120) (name "Riley") (address "567 Oak St") (phone 331555666)    (refered-by ) )
)

          ;;Aqui definimos lo que los clientes ordenaron, lo matcheamos
(deffacts orders
  (order (order-number 300) (customer-id 102) (purchase-date "2023-01-10"))
  (order (order-number 301) (customer-id 103) (purchase-date "2023-05-15"))
  (order (order-number 302) (customer-id 104) (purchase-date "2023-08-22"))
  (order (order-number 303) (customer-id 105) (purchase-date "2023-09-15"))
  (order (order-number 304) (customer-id 106) (purchase-date "2023-10-02"))
  (order (order-number 305) (customer-id 107) (purchase-date "2023-09-10"))
  (order (order-number 306) (customer-id 108) (purchase-date "2023-09-28"))
  (order (order-number 307) (customer-id 109) (purchase-date "2023-09-20"))
  (order (order-number 308) (customer-id 110) (purchase-date "2023-09-05"))
...
(deffacts drivers
   (driver (name "Daniel Silva") (dateBorn "1985-03-03"))
   (driver (name "Carlos Santos") (dateBorn "2000-03-04"))
   
   (driver (name "Denial Solva") (dateBorn "2000-03-18"))
   (driver (name "Cerlus Sentos") (dateBorn "2000-03-02"))
)
